...
import com.example.tikz.personalassistantuk.reminder.EventAlarmScheduler;
import com.getbase.floatingactionbutton.FloatingActionButton;
import com.wdullaer.materialdatetimepicker.date.DatePickerDialog;
import com.wdullaer.materialdatetimepicker.time.RadialPickerLayout;
import com.wdullaer.materialdatetimepicker.time.TimePickerDialog;

public class    Popup_Event extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener,
    ...
    private TextView mDateText, mTimeText, mTimerText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCurrentReminderUri == null) {
            ...
            setTitle(getString(R.string.editor_title_popup_edit_event));
        ...
        mInfoText = (EditText) findViewById(R.id.event_details);
        mTitleText = (EditText) findViewById(R.id.event_title);
        mDateText = (TextView) findViewById(R.id.set_date_event);
        mTimeText = (TextView) findViewById(R.id.set_time_event);
        mTimerText = (TextView) findViewById(R.id.set_timer_event);
        ...
        mTimerText.setText(mTimer);


        // To save state on device rotation
        if (savedInstanceState != null) {
            String savedTitle = savedInstanceState.getString(MahasiswaDBOpenHelper.COL_EVENT_NAME);
            mTitleText.setText(savedTitle);
            mTitle = savedTitle;

            String savedInfo = savedInstanceState.getString(MahasiswaDBOpenHelper.COL_EVENT_INFO);
            mInfoText.setText(savedInfo);
            mInfo = savedInfo;

            String savedTime = savedInstanceState.getString(MahasiswaDBOpenHelper.COL_EVENT_TIME);
            mTimeText.setText(savedTime);
            mTime = savedTime;

            String savedDate = savedInstanceState.getString(MahasiswaDBOpenHelper.COL_EVENT_DATE);
            mDateText.setText(savedDate);
            mDate = savedDate;

            String saveTimer = savedInstanceState.getString(MahasiswaDBOpenHelper.COL_EVENT_TIMER);
            mTimerText.setText(saveTimer);
            mTimer = saveTimer;
    ...
    protected void onSaveInstanceState (Bundle outState) {
        ...
        outState.putCharSequence(MahasiswaDBOpenHelper.COL_EVENT_NAME, mTitleText.getText());
        outState.putCharSequence(MahasiswaDBOpenHelper.COL_EVENT_INFO, mInfoText.getText());
        outState.putCharSequence(MahasiswaDBOpenHelper.COL_EVENT_TIME, mTimeText.getText());
        outState.putCharSequence(MahasiswaDBOpenHelper.COL_EVENT_DATE, mDateText.getText());
        outState.putCharSequence(MahasiswaDBOpenHelper.COL_EVENT_TIMER, mTimerText.getText());
        outState.putCharSequence(MahasiswaDBOpenHelper.COL_EVENT_ACTIVE, mActive);
    }
        ...
        switch (item.getItemId()) {
            ...
            case R.id.save_reminder:
                ...
                if (mTitleText.getText().toString().length() == 0){
                    mTitleText.setError("ScheduleActivity title cannot be blank!");
                }
            ...
            case android.R.id.home:
                ...
                if (!mVehicleHasChanged) {
                    NavUtils.navigateUpFromSameTask(Popup_Event.this);
                    return true;
                }
    ...
    private void deleteReminder() {
        ...
        if (mCurrentReminderUri != null) {
            ...
            if (rowsDeleted == 0) {
                ...
                new EventAlarmScheduler().cancelAlarmEvent(getApplicationContext(), mCurrentReminderUri);
...
*/
        ...
        values.put(MahasiswaDBOpenHelper.COL_EVENT_NAME, mTitle);
        values.put(MahasiswaDBOpenHelper.COL_EVENT_INFO, mInfo);
        values.put(MahasiswaDBOpenHelper.COL_EVENT_DATE, mDate);
        values.put(MahasiswaDBOpenHelper.COL_EVENT_TIME, mTime);
        values.put(MahasiswaDBOpenHelper.COL_EVENT_TIMER, mTimer);
        values.put(MahasiswaDBOpenHelper.COL_EVENT_ACTIVE, mActive);
        ...
        selectedTimestamp = selectedTimestamp - timer;
        ...
        if (mActive.equals("true")) {
            new EventAlarmScheduler().setAlarmEvent(getApplicationContext(), selectedTimestamp, mCurrentReminderUri);
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int infoColumnIndex = cursor.getColumnIndex(MahasiswaDBOpenHelper.COL_EVENT_INFO);
